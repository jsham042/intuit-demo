...
st.markdown("""
    ...
    * {
    ...
    /* Hide empty iframes (like the JavaScript keyboard shortcut) */
    .stIFrame[height="0px"],
    iframe[height="0"],
    .element-container[height="0px"],
    div[data-testid="stElementContainer"][height="0px"],
    .element-container:has(.stIFrame),
    ...
    /* Hide markdown containers with only <br> tags */
    div[data-testid="stMarkdownContainer"]:has(br:only-child) {
        display: none !important;
        height: 0 !important;
        margin: 0 !important;
        padding: 0 !important;
    ...
    .stFormSubmitButton > button:hover {
        ...
        box-shadow: 0 4px 8px rgba(5, 83, 147, 0.2) !important;
